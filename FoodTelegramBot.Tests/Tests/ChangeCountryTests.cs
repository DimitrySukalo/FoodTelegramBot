...
{
    public class ChangeCountryTests
    {
        [Fact]
        ...
        [Fact]
        private async Task ExecuteMethodReturnsNotValidCountry()
        {
            //Arrange
            var mocks = GetMocks();
            ...
            var message = new Message()
            {
                ...
                Text = "/changeCountry@YourNewCountry"
            };
            ...
            Assert.Equal("Not valid country", result?.Message);
        ...
        [Fact]
        private async Task ExecuteMethodReturnsCountryIsChanged()
        {
            //Arrange
            var mocks = GetMocks();
            var users = GetUsers().AsQueryable().BuildMock();
            ...
            Assert.Equal("Country is changed", result?.Message);
        }
