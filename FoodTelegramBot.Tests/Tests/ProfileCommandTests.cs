...
namespace FoodTelegramBot.Tests.Tests
{
    public class ProfileCommandTests
    {
        ...
        private void ContaintMethodReturnsFalse()
        {
            ...
            var profileCommand = new ProfileCommand(dbMock.Object);
            ...
            //Act
            var result = profileCommand.IsContains(message);
        ...
        private async Task ExecuteMethodReturnsUserIsNull()
        {
            ...
            var profileCommand = new ProfileCommand(mocks.dbMock.Object);
            ...
            //Act
            var result = await profileCommand.Execute(message, client);
        ...
        [Fact]
        private async Task ExecuteMethodReturnsDataIsSended()
        {
            //Arrange
            var mocks = GetMocks();
            var users = GetUsers().AsQueryable().BuildMock();
            ...
            Assert.Equal("Data is sended", result?.Message);
        }
